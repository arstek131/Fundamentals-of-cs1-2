...
extern void ricerca(char *s, list l);//Ricerca di un elemento nella lista
...
extern void insertTail(element e, list l);//Inserimento in coda
extern element insertData(element *e);//Prende in input i dati della struct indirizzo
extern list elimIndirizzo(char *s, list l);
